...
public class PopupDialogActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final float percentFromTop = this.getIntent().getExtras().getFloat(CONSTANTS_PERCENT_FROM_TOP_EXTRA);
        ...
        ll.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                ...
                if (ll.getMeasuredHeight() > distanceToBottomOfScreen) {
        ...
        percentLayoutInfo.topMarginPercent = percentFromTop;
