...
public class BackgroundService extends IntentService
{
    ...
    private void registerDeviceForNotifications(@NonNull final Intent intent) {
        try {
            ...
            final Response<ResponseBody> response = GodToolsV2Api.getInstance(this).legacy
    ...
    private void authenticateAccessCode(@NonNull final Intent intent) {
        try {
            ...
            final Response<ResponseBody> response =
                    GodToolsV2Api.getInstance(this).legacy.getAuthToken(intent.getStringExtra(ACCESS_CODE)).execute();
            //Added Logging
    ...
    private void verifyAuthToken(@NonNull final Intent intent) {
        try {
            ...
            final Response<ResponseBody> response =
                    GodToolsV2Api.getInstance(this).legacy.verifyAuthToken(authToken).execute();
