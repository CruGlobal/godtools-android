...
public class SnuffyActivity extends Activity {
	...
	private View createToolbar() {
		...
		return inflater.inflate(R.layout.toolbar1, null);		
	}
	private void addTheToolBar() {
		AbsoluteLayout layout = (AbsoluteLayout)findViewById(R.id.snuffyMainLayout);
		mToolBar.measure(
    			MeasureSpec.makeMeasureSpec(mPageWidth, MeasureSpec.EXACTLY), 
    			MeasureSpec.UNSPECIFIED);
		mToolBar.setVisibility(View.INVISIBLE);
		mToolBar.setLayoutParams(new SnuffyLayoutParams(
				mPageWidth, 
				LayoutParams.WRAP_CONTENT, 
				mPageLeft, 
				mPageTop + mPageHeight - mToolBar.getMeasuredHeight()));
	...
	private void showTheToolBar() {
		//mToolBar.setVisibility(View.VISIBLE); // no longer used
		// we use the standard Android options menu instead
		openOptionsMenu();
		
	}
	private void toggleTheToolBar() {
	...
	public void doCmdShowPageMenu(View v) {
		hideTheToolBar();
    	Intent intent = new Intent(this,SnuffyPageMenuActivity.class );
    ...
    private class ProcessPackageAsync 
		...
		protected Integer doInBackground(String... params) {
			...
			try {
				bSuccess = packageReader.processPackage(
							(SnuffyApplication)getApplication(), 
							mPageWidth, mPageHeight,
							mAppPackage, mAppLanguage, 
							mPages, 
