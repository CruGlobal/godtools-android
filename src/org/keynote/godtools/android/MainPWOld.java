...
public class MainPWOld extends BaseActionBarActivity implements OnLanguageChangedListener, OnPackageSelectedListener, DownloadTask.DownloadTaskHandler, MetaTask.MetaTaskHandler
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.main_pw_old);
		setUpActionBar();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data)
	{
		...
		switch (resultCode)
		{
			...
			case RESULT_PREVIEW_MODE_ENABLED:
			{
				...
				Toast.makeText(MainPWOld.this, "Translator preview mode is enabled", Toast.LENGTH_LONG).show();
				break;
			}
			case RESULT_PREVIEW_MODE_DISABLED:
			{
				...
				Toast.makeText(MainPWOld.this, "Translator preview mode is disabled", Toast.LENGTH_LONG).show();
				break;
			}
		}
	...
	public void refresh(View view)
	{
		...
		if (Device.isConnected(MainPWOld.this))
		{
			SharedPreferences settings = getSharedPreferences(PREFS_NAME, MODE_PRIVATE);
			String authorization = settings.getString("authorization", getString(R.string.key_authorization_generic));
		...
		{
			Toast.makeText(MainPWOld.this, "Internet connection is required", Toast.LENGTH_SHORT).show();
		}
	}
	...
	private List<GTPackage> getPackageList()
	{
		if (isTranslatorModeEnabled())
		{
			return GTPackage.getPackageByLanguage(MainPWOld.this, languagePrimary);
		} else
		{
			return GTPackage.getLivePackages(MainPWOld.this, languagePrimary);
		}
	}
	...
	public void onLanguageChanged(String name, String code)
	{
		...
		GTLanguage gtLanguage = GTLanguage.getLanguage(MainPWOld.this, code);
	...
	public void downloadTaskComplete(String url, String filePath, String langCode, String tag)
	{
		...
		if (tag.equalsIgnoreCase("primary"))
		{
			...
			GTLanguage gtl = GTLanguage.getLanguage(MainPWOld.this, langCode);
			gtl.setDownloaded(true);
			gtl.update(MainPWOld.this);
		...
		} else if (tag.equalsIgnoreCase("draft"))
		{
			...
			Toast.makeText(MainPWOld.this, "Drafts have been updated", Toast.LENGTH_SHORT).show();
			packageList = getPackageList();
			packageFrag.refreshList(langCode, packageList);
			hideLoading();
	...
	public void metaTaskFailure(InputStream is, String langCode, String tag)
	{
		...
		hideLoading();
		Toast.makeText(MainPWOld.this, "Failed to update drafts", Toast.LENGTH_SHORT).show();
	...
	public void downloadTaskFailure(String url, String filePath, String langCode, String tag)
	{
		...
		} else if (tag.equalsIgnoreCase("draft_primary"))
		{
			...
			packageList = getPackageList();
			packageFrag.refreshList(langCode, packageList);
			Toast.makeText(MainPWOld.this, "Failed to download drafts", Toast.LENGTH_SHORT).show();
		...
		} else if (tag.equalsIgnoreCase("primary") || tag.equalsIgnoreCase("parallel"))
		{
			...
			Toast.makeText(MainPWOld.this, "Failed to download resources", Toast.LENGTH_SHORT).show();
	...
	private class UpdateDraftListTask extends AsyncTask<Object, Void, Boolean>
	{
		...
		protected void onPostExecute(Boolean shouldDownload)
		{
			...
			if (shouldDownload)
			{
				...
				SharedPreferences settings = getSharedPreferences(PREFS_NAME, MODE_PRIVATE);
				String authorization = settings.getString("authorization", getString(R.string.key_authorization_generic));
				GodToolsApiClient.downloadDrafts((SnuffyApplication) getApplication(), authorization, langCode, tag, MainPWOld.this);
