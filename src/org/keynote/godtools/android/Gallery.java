...
public class Gallery extends Activity
{
    ...
    private synchronized int getNextFlipId(int curId)
    {
        switch (curId)
        {
            case R.id.gallery_image0:
                return R.id.gallery_image1;
            case R.id.gallery_image1:
                return R.id.gallery_image2;
            case R.id.gallery_image2:
    ...
    private void resetZoomState(int view)
    {
        ...
        {
            case 0:
                mZoomControl = mZoomControl0;
                mZoomView = mZoomView0;
                break;
            case 1:
                mZoomControl = mZoomControl1;
                mZoomView = mZoomView1;
                break;
            case 2:
                mZoomControl = mZoomControl2;
                mZoomView = mZoomView1;
                break;
        }
