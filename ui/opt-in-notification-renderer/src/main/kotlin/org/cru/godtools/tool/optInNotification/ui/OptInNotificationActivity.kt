package org.cru.godtools.tool.optInNotification.ui
...
import org.cru.godtools.tool.optInNotification.BuildConfig.HOST_GODTOOLS_CUSTOM_URI
import org.cru.godtools.tool.optInNotification.R
import org.cru.godtools.tool.optInNotification.analytics.model.LessonPageAnalyticsScreenEvent
import org.cru.godtools.tool.optInNotification.databinding.LessonActivityBinding
import org.cru.godtools.tool.optInNotification.ui.feedback.LessonFeedbackDialogFragment
import org.cru.godtools.tool.optInNotification.ui.resume.LessonResumeDialogFragment
import org.cru.godtools.tool.optInNotification.ui.swipetutorial.OptInNotificationModalOverlay
import org.cru.godtools.tool.optInNotification.util.isLessonDeepLink
import org.cru.godtools.user.activity.UserActivityManager

private const val TAG_RESUME_DIALOG = "resume_dialog"

@AndroidEntryPoint
class OptInNotificationActivity :
    BaseSingleToolActivity<LessonActivityBinding>(
        contentLayoutId = R.layout.lesson_activity,
        requireTool = true,
        supportedType = Manifest.Type.LESSON
    ),
    OptInNotificationPageAdapter.Callbacks {
    ...
    private fun setupProgressTracking() {
        dataModel.pages.observe(this@OptInNotificationActivity) { updateProgress(pages = it) }
    }
    ...
    // region Pages
    @Inject
    lateinit var lessonPageAdapterFactory: OptInNotificationPageAdapter.Factory
    ...
    private fun LessonActivityBinding.setupPages() {
        ...
        dataModel.pages.observe(this@OptInNotificationActivity) { lessonPages ->
            ...
            GodToolsTheme(darkTheme = false) {
                ContentWithOverlays {
                    ...
                    if (showSwipeTutorial) {
                        OverlayEffect {
                            delay(800)
                            show(OptInNotificationModalOverlay())
