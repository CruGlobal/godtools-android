...
import org.cru.godtools.tool.optInNotification.ui.controller.LessonPageController
import org.cru.godtools.tool.optInNotification.ui.controller.bindController

class OptInNotificationPageAdapter @AssistedInject internal constructor(
    ...
    @AssistedFactory
    interface Factory {
        fun create(lifecycleOwner: LifecycleOwner, callbacks: Callbacks?, toolState: State): OptInNotificationPageAdapter
    }
